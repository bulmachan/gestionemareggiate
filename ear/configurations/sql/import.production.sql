...
--CREATE TABLE  "MRG_USER"."MRG_F_DANNI_LIN" 
...
--CREATE TABLE  "MRG_USER"."MRG_F_DANNI_POL" 
--(	"OBJECTID" integer NOT NULL ENABLE, 
--	"SHAPE" sde.st_geometry NOT NULL ENABLE , 
--	 PRIMARY KEY ("Objectid")   ENABLE
--);
...
--CREATE TABLE  "MRG_USER"."MRG_F_DANNI_PUN" 
-- (	"OBJECTID" integer NOT NULL ENABLE, 
--	"SHAPE" sde.st_geometry NOT NULL ENABLE , 
--	 PRIMARY KEY ("Objectid")   ENABLE
--);
...
--Insert into MRG_STB (ID,NOME) values ('1','STB Po di Volano e della costa');
--Insert into MRG_STB (ID,NOME) values ('2','STB Romagna - sede Rimini');
--Insert into MRG_STB (ID,NOME) values ('3','STB Romagna - sede Cesena');
--Insert into MRG_STB (ID,NOME) values ('4','STB Romagna - sede Ravenna');
